...
//         //   "https://hirely-job-portal.onrender.com/api/v1/user/register",
//         //   formData,
//         //   {
...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (!input.fullname) formErrors.fullname = "Full name is required";
    if (!input.email) formErrors.email = "Email is required";
    if (!input.phoneNumber) formErrors.phoneNumber = "Phone number is required";
    if (!input.password) formErrors.password = "Password is required";
